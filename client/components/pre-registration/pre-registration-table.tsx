...
const PreRegistrationTable: React.FC = () => {
  ...
  const apiUrl = `/api/preregistration/get?page=${pagination?.pageIndex + 1}&limit=${pagination?.pageSize}&searchTitle=${''}&search=${searchQuery}&sort=${sort[0]?.id}&order=${
