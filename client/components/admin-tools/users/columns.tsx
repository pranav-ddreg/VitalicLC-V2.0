    ...
    () => [
      {
        ...
        header: ({ column }) => (
          <DataTableColumnHeader column={column} title="FirstName" className="text-neutral-500" />
        ),
        cell: ({ row }) => (
          <div className="w-[200px] flex gap-2 py-2">
            <span>{String(row?.original?.firstName)}</span>
          </div>
        ),
        enableSorting: true,
        enableHiding: true,
      },
      {
        ...
        header: ({ column }) => <DataTableColumnHeader column={column} title="LastName" className="text-neutral-500" />,
        cell: ({ row }) => (
          <div className="w-[200px] flex gap-2 py-2">
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div className="w-[200px] flex gap-2 py-2">
            <span>{String(row?.original?.role?.title)}</span>
          </div>
        ),
        enableSorting: true,
        enableHiding: true,
